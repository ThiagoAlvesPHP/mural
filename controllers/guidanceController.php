...
class guidanceController extends controller {
	...
	public function index() {
		$this->array['list'] = $this->guidance->list();
	...
	public function actions()
	{
		...
		if (!empty($this->post['set'])) {
			...
			if ($this->guidance->validate($this->post['title'])) {
				$this->guidance->set($this->post);
		...
		if(!empty($this->get['del'])) {
			$this->guidance->delete($this->get['del']);
