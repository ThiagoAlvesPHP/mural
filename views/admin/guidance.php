<section class="guidance-admin">
    <h1 class="title"><i class="fas fa-genderless"></i> Orientação</h1>
    <hr>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <?php endif; ?>
            <form action="<?=BASE; ?>guidance/actions" method="POST">
                    ...
                    <?php if(!empty($list)): ?>
                        <?php foreach ($list as $value): ?>
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="<?=BASE; ?>guidance/actions?del=<?=$value['id']; ?>" class="btn btn-danger">
